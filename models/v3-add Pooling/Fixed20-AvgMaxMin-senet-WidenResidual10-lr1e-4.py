...
run = wandb.init(
    ...
    config={
        ...
        "epochs": 10,
        "batch_size": 256,
        "structure": "widen-avgmaxmin-fixed emb20-att-senet-residual 10",
    })
...
for epoch in range(10):
    ...
    # save the model
    torch.save(model.state_dict(), 'widen_avgmaxmin_fixed_model_v1_10blks.pth')


# # load the model
# model.load_state_dict(torch.load('widen_avgmaxmin_fixed_model_v1_10blks.pth'))
