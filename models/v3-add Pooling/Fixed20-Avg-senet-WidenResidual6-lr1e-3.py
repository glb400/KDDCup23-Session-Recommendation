...
run = wandb.init(
    ...
    config={
        ...
        "epochs": 10,
        "batch_size": 256,
        "structure": "widen-avg-fixed emb20-att-senet-residual 6-fc",
    })
...
for epoch in range(10):
    ...
    # save the model
    torch.save(model.state_dict(), 'widen_avg_20embs_fixed_model_v1_6blks.pth')

# # load the model
# model.load_state_dict(torch.load('widen_avg_20embs_fixed_model_v1_6blks.pth'))
