...
run = wandb.init(
    ...
    config={
        ...
        "epochs": 10,
        "batch_size": 256,
        "structure": "avg-fixed emb-att-senet-residual 6-fc",
    })
...
for epoch in range(10):
    ...
    # save the model
    torch.save(model.state_dict(), 'avg_fixed_model_v1_6blks.pth')

# # load the model
# model.load_state_dict(torch.load('avg_fixed_model_v1_6blks.pth'))
