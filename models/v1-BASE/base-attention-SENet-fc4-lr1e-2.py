...
run = wandb.init(
    ...
    config={
        ...
        "epochs": 10,
        "batch_size": 256,
        "structure": "att-senet-fc-same-dim",
    })
...
class Model(nn.Module):
    def __init__(self, input_dim, output_dim, vocab_size):
        ...
        # keep the dimension of the output of SENet
        self.fc1 = nn.Linear(2 * input_dim, 2 * input_dim)
        
        self.fc2 = nn.Linear(2 * input_dim, 2 * input_dim)
        
        self.fc3 = nn.Linear(2 * input_dim, 2 * input_dim)
